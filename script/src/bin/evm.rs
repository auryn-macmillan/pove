...
pub const PARAMS_ELF: &[u8] = include_bytes!("../../../elf/riscv32im-succinct-zkvm-elf");
...
fn main() {
    ...
    // Setup the program.
    let (pk, vk) = client.setup(PARAMS_ELF);
...
fn create_plonk_fixture(proof: &SP1ProofWithPublicValues, vk: &SP1VerifyingKey) {
    ...
    let fixture = SP1paramsProofFixture {
        degree,
        plaintext_modulus,
        moduli,
        params,
